...
class Conf():
    ...
    lr = 1e-4
    num_epochs = 10000
    num_trials = 4  # per epoch; timesteps = num_trials * 4  (reward, delay, init, choice)
    ...
    r_step, init_step, a_step, b_step, init_choice_step, ab_choice_step = 0, None, 0, 1, None, 1
